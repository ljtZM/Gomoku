...
public class PaintPanel4 extends BackgroundPanel{
	 private int gap = 15;
	    private int unit = 10;
	    ...
	    public PaintPanel4() {
	        ...
	        addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseReleased(MouseEvent e) {
	                ...
	                Vars.control4.reportUserPressMouse(row, col);
	                
	                Vars.control4.makeComputerMove();
	       ...
	       // 添加按钮到面板
	        ...
	        GiveinButton.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
	                JOptionPane.showMessageDialog(PaintPanel4.this, "AI胜利！");
				}
			});
	    ...
	    protected void ReBegin() {
	        Vars.control4.resetGame1();  
	        Vars.control4.chessColor=ShapeModel.BLACK;
	    ...
	    private void drawChess(Graphics g) {
	        for (int row = 0; row < ShapeModel.WIDTH; row++) {
	            for (int col = 0; col < ShapeModel.WIDTH; col++) {
	                int c = Vars.model4.getChess(row, col);
